...
class KreirajStavkuPozajmiceSOTest {

    private KreirajStavkuPozajmiceSO so;
    private Pozajmica pozajmica;
    private Knjiga knjiga;

    @BeforeEach
    void setUp() throws Exception {
        so = new KreirajStavkuPozajmiceSO();
    ...
    private StavkaPozajmice validStavka() throws Exception {
        return new StavkaPozajmice(1, pozajmica, null, false, 1, knjiga);
    }
