...
/**
 * Sistemska operacija za izmenu postojece stavke pozajmice.
 *
 * @author Petar
 */
public class AzurirajStavkuPozajmiceSO extends ApstraktnaGenerickaOperacija {
    ...
    protected void preduslovi(Object param) throws Exception {
        ...
        /*
        if(sp.isVraceno() == null){
            throw new Exception("GRESKA VRACENO");
        }
        */
    ...
    /**
     * Azurira podatke postojece stavke pozajmice u bazi podataka.
     *
    ...
    protected void izvrsiOperaciju(Object param, String kljuc) throws Exception {
        broker.edit((StavkaPozajmice)param);
    }
