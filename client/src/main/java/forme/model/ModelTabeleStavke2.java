 ...
 * @author Petar
 */
public class ModelTabeleStavke2 extends AbstractTableModel {

    List<StavkaPozajmice> lista;
    String[] kolone = {"datumVracanja", "vraceno", "kazna", "knjiga", "autor"};

    SimpleDateFormat dateFormat = new SimpleDateFormat("dd.MM.yyyy");
    
    public ModelTabeleStavke2(List<StavkaPozajmice> lista) {
        this.lista = lista;
    }
